...
INSTALL_PREFIX="${HOME_BASE}/install_GPU_llvm19-cmpich"
...
cmake \
    ...
    -D CMAKE_CXX_FLAGS="-L/opt/cray/pe/mpich/8.1.28/gtl/lib -L/opt/nvidia/hpc_sdk/Linux_x86_64/23.9/cuda/12.2/lib64 -lcudart -lmpi_gtl_cuda" \
