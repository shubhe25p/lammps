...
#SBATCH -C gpu
#SBATCH -t 00:10:00
#SBATCH -J lmp_nano_llvm+mpich
#SBATCH -o lmp_nano_llvm+mpich.o%j
#SBATCH -A nintern
#SBATCH -n 1
#SBATCH -c 32
...
mkdir lammps_llvm_mpich_$spec.$SLURM_JOB_ID
cd    lammps_llvm_mpich_$spec.$SLURM_JOB_ID
ln -s ../../common .
cp ${0} .
cp ../nano_spec.txt .

# This is needed if LAMMPS is built using cmake.
install_dir="../../../install_GPU_llvm-mpich"
